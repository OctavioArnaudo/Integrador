...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxHiltCompilerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v100</b> with <b>androidx.hilt:hilt-compiler</b> coordinates and
         * with version reference <b>hiltCompilerVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV100() {
            return create("androidx.hilt.compiler.v100");
        }
    ...
    public static class AndroidxJunitLibraryAccessors extends SubDependencyFactory {
        private final AndroidxJunitKtxLibraryAccessors laccForAndroidxJunitKtxLibraryAccessors = new AndroidxJunitKtxLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.junit.ktx</b>
         */
        public AndroidxJunitKtxLibraryAccessors getKtx() {
            return laccForAndroidxJunitKtxLibraryAccessors;
        }

    }

    public static class AndroidxJunitKtxLibraryAccessors extends SubDependencyFactory {

        public AndroidxJunitKtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v100</b> with <b>androidx.test.ext:junit-ktx</b> coordinates and
         * with version reference <b>junitKtx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV100() {
            return create("androidx.junit.ktx.v100");
        }
    ...
    public static class GradleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v852</b> with <b>com.android.tools.build:gradle</b> coordinates and
         * with version reference <b>gradle</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV852() {
            return create("gradle.v852");
        }
    ...
    public static class HiltAndroidGradlePluginLibraryAccessors extends SubDependencyFactory {

        public HiltAndroidGradlePluginLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v100</b> with <b>com.google.dagger:hilt-android-gradle-plugin</b> coordinates and
         * with version reference <b>hiltAndroidGradlePlugin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV100() {
            return create("hilt.android.gradle.plugin.v100");
        }
    ...
    public static class SpotlessPluginLibraryAccessors extends SubDependencyFactory {
        private final SpotlessPluginGradleLibraryAccessors laccForSpotlessPluginGradleLibraryAccessors = new SpotlessPluginGradleLibraryAccessors(owner);

        public SpotlessPluginLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>spotless.plugin.gradle</b>
         */
        public SpotlessPluginGradleLibraryAccessors getGradle() {
            return laccForSpotlessPluginGradleLibraryAccessors;
        }

    }

    public static class SpotlessPluginGradleLibraryAccessors extends SubDependencyFactory {

        public SpotlessPluginGradleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v100</b> with <b>com.diffplug.spotless:spotless-plugin-gradle</b> coordinates and
         * with version reference <b>spotlessPluginGradle</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV100() {
            return create("spotless.plugin.gradle.v100");
        }
    ...
    public static class TruthLibraryAccessors extends SubDependencyFactory {

        public TruthLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v100</b> with <b>com.google.truth:truth</b> coordinates and
         * with version reference <b>truth</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV100() {
            return create("truth.v100");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hiltCompilerVersion</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.compose.bom</b> with value <b>2024.08.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class DesugarJdkVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>desugar.jdk.libs</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
